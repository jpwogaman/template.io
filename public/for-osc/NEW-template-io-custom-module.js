...
const allTrack_jsn = loadJSON('Tracklist_10.13.2022_V1.4.json') //`${or whatever the user names their file}`
...
const allNotes_loc = []
for (let i = -2; i < 9; i++) {
    allNotes_loc.push('C' + i, 'C#' + i, 'D' + i, 'D#' + i, 'E' + i, 'F' + i, 'F#' + i, 'G' + i, 'G#' + i, 'A' + i, 'A#' + i, 'B' + i)
}
...
module.exports = {
    ...
    oscInFilter: function (data) {
        ...
        if (keyP) {
            ...
            const artListJsn = [...items[trkNumb].artListTog, ...items[trkNumb].artListSwitch]
