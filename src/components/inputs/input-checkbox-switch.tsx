      ...
      <label
        ...
        <div
          className={tw(
            ...
            'peer-checked:bg-green-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-hidden dark:peer-checked:bg-green-800'
          )}
        />
      </label>
    </div>
