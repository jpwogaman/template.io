      ...
      <label
        ...
        <div
          className={twMerge(
            ...
            'peer-checked:bg-green-600 peer-focus:outline-hidden peer-checked:after:translate-x-full peer-checked:after:border-white dark:peer-checked:bg-green-800'
          )}
        />
      </label>
    </div>
