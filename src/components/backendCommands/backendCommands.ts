...
export type ItemsArtListTog = { id: SubItemId; name: string; toggle: boolean; code_type: string; code: number; on: number; off: number; default: string; delay: number; change_type: string; ranges: string; art_layers: string; fileitems_item_id: FileItemId }
export type ItemsArtListTogRequest = { id: SubItemId; name?: string | null; toggle?: boolean | null; code_type?: string | null; code?: number | null; on?: number | null; off?: number | null; default?: string | null; delay?: number | null; change_type?: string | null; ranges?: string | null; art_layers?: string | null; fileitems_item_id?: FileItemId | null }
