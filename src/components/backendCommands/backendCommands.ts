...
export type ItemsArtLayers = { id: SubItemId; name: string; code_type: string; code: number; on: number; off: number; default: string; change_type: string; fileitems_item_id: FileItemId }
export type ItemsArtLayersRequest = { id: SubItemId; name?: string | null; code_type?: string | null; code?: number | null; on?: number | null; off?: number | null; default?: string | null; change_type?: string | null; fileitems_item_id?: FileItemId | null }
export type ItemsArtListTap = { id: SubItemId; name: string; toggle: boolean; code_type: string; code: number; on: number; off: number; default: boolean; delay: number; change_type: string; ranges: string; art_layers: string; fileitems_item_id: FileItemId }
export type ItemsArtListTapRequest = { id: SubItemId; name?: string | null; toggle?: boolean | null; code_type?: string | null; code?: number | null; on?: number | null; off?: number | null; default?: boolean | null; delay?: number | null; change_type?: string | null; ranges?: string | null; art_layers?: string | null; fileitems_item_id?: FileItemId | null }
