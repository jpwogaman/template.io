...
export const commands = {
  ...
  async getFileitemAndRelations(
    id: string
  ): Promise<FullTrackForExport | null> {
  ...
  async deleteFullRangeByFileitem(
    id: string,
  ...
  async deleteArtLayerByFileitem(
    id: string,
    fileitemsItemId: string
  ): Promise<void> {
...
export type FileItemRequest = {
  ...
  notes?: string | null
  channel?: number | null
  base_delay?: number | null
  avg_delay?: number | null
  vep_out?: string | null
  vep_instance?: string | null
  smp_number?: string | null
  smp_out?: string | null
  color?: string | null
}
...
export type FullTrackForExport = {
  ...
  full_ranges: ItemsFullRanges[]
  fad_list: ItemsFadList[]
  art_list_tog: ItemsArtListTog[]
  art_list_tap: ItemsArtListTap[]
  art_layers: ItemsArtLayers[]
}
