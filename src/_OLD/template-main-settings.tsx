  ...
  return (
    <div>
      ...
      <input
        ...
        checked={isChecked2}
        onChange={closeOnSave}></input>

      <h2>Note Numbers</h2>
      <TdSelect
        id='findMiddleC'
        options='middleCOption'></TdSelect>

      <h2>Track Settings</h2>

      <label htmlFor='vepOutSettings'>Number of Outputs per Instance</label>
      <TdSelect
        id='vepOutSettings'
        options='vepOutOption'></TdSelect>

      <label htmlFor='smpOutSettings'>Number of Outputs per Sampler</label>
      <TdSelect
        id='smpOutSettings'
        options='vepOutOption'></TdSelect>
